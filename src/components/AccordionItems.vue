<template>
  <div id="accordion" v-for="(data, i) in formDataArray" v-bind:key="i" style="width: 1109px; height 1000px">
    <div class="card">
      ...
      >
        <div class="card-body" style="width: 1000px; height 1000px">
          ...
          <p class="mb-0"><strong>คำร้อง: </strong>{{ data.reason }}</p>
        </div>
      </div>
    </div>
  </div>
